...
-- state_out[0]	=>  Location: PIN_93,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \dut_instance|add_instance|Mux3~0_combout\ : std_logic;
...
SIGNAL \dut_instance|add_instance|Mux3~1_combout\ : std_logic;
SIGNAL \dut_instance|add_instance|Equal1~2_combout\ : std_logic;
SIGNAL \dut_instance|add_instance|Mux3~2_combout\ : std_logic;
...
SIGNAL \datau[3]~13_combout\ : std_logic;
...
-- Equation(s):
-- \dut_instance|add_instance|LessThan0~1_combout\ = (dut_input(5) & (((!dut_input(0) & dut_input(4))) # (!dut_input(1)))) # (!dut_input(5) & (!dut_input(0) & (!dut_input(1) & dut_input(4))))
...
-- Equation(s):
-- \dut_instance|add_instance|Equal1~0_combout\ = (dut_input(2) & (dut_input(6) & (dut_input(7) $ (!dut_input(3))))) # (!dut_input(2) & (!dut_input(6) & (dut_input(7) $ (!dut_input(3)))))
...
-- Equation(s):
-- \dut_instance|add_instance|LessThan0~2_combout\ = (\dut_instance|add_instance|LessThan0~0_combout\) # ((\dut_instance|add_instance|LessThan0~1_combout\ & \dut_instance|add_instance|Equal1~0_combout\))
...
-- pragma translate_on
PORT MAP (
	dataa => \dut_instance|add_instance|LessThan0~1_combout\,
	datab => \dut_instance|add_instance|LessThan0~0_combout\,
	datad => \dut_instance|add_instance|Equal1~0_combout\,
	combout => \dut_instance|add_instance|LessThan0~2_combout\);

-- Location: LCCOMB_X36_Y21_N20
\dut_instance|add_instance|Mux3~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \dut_instance|add_instance|Mux3~0_combout\ = (dut_input(7) & (((dut_input(4) & dut_input(0))))) # (!dut_input(7) & ((\dut_instance|add_instance|LessThan0~2_combout\ & (dut_input(4))) # (!\dut_instance|add_instance|LessThan0~2_combout\ & 
-- ((dut_input(0))))))
...
-- pragma translate_on
PORT MAP (
	dataa => \dut_instance|add_instance|LessThan0~2_combout\,
	datab => dut_input(4),
	datac => dut_input(0),
	datad => dut_input(7),
	combout => \dut_instance|add_instance|Mux3~0_combout\);

-- Location: LCCOMB_X36_Y21_N10
\dut_instance|add_instance|Equal1~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \dut_instance|add_instance|Equal1~1_combout\ = (dut_input(1) & (dut_input(5) & (dut_input(0) $ (!dut_input(4))))) # (!dut_input(1) & (!dut_input(5) & (dut_input(0) $ (!dut_input(4)))))
...
-- Equation(s):
-- \dut_instance|add_instance|Equal0~0_combout\ = (dut_input(4)) # ((dut_input(5)) # ((dut_input(7)) # (dut_input(6))))
...
-- Equation(s):
-- \dut_instance|add_instance|Equal0~1_combout\ = (\dut_instance|add_instance|Equal1~1_combout\ & (\dut_instance|add_instance|Equal1~0_combout\ & \dut_instance|add_instance|Equal0~0_combout\))
...
-- pragma translate_on
PORT MAP (
	dataa => \dut_instance|add_instance|Equal1~1_combout\,
...
\dut_instance|add_instance|Mux3~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \dut_instance|add_instance|Mux3~1_combout\ = (dut_input(3) & (((dut_input(7))))) # (!dut_input(3) & (\dut_instance|add_instance|Mux3~0_combout\ & ((dut_input(7)) # (!\dut_instance|add_instance|Equal0~1_combout\))))
...
PORT MAP (
	dataa => dut_input(3),
	datab => \dut_instance|add_instance|Mux3~0_combout\,
	datac => dut_input(7),
	datad => \dut_instance|add_instance|Equal0~1_combout\,
	combout => \dut_instance|add_instance|Mux3~1_combout\);

-- Location: LCCOMB_X37_Y21_N14
\dut_instance|add_instance|Equal1~2\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \dut_instance|add_instance|Equal1~2_combout\ = (\dut_instance|add_instance|Equal1~1_combout\ & \dut_instance|add_instance|Equal1~0_combout\)
...
PORT MAP (
	...
	combout => \dut_instance|add_instance|Equal1~2_combout\);

-- Location: LCCOMB_X37_Y21_N22
\dut_instance|add_instance|Mux3~2\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \dut_instance|add_instance|Mux3~2_combout\ = (dut_input(3) & ((\dut_instance|add_instance|Mux3~1_combout\ & (\dut_instance|add_instance|Equal1~2_combout\ & dut_input(4))) # (!\dut_instance|add_instance|Mux3~1_combout\ & ((!dut_input(4)))))) # 
-- (!dut_input(3) & (\dut_instance|add_instance|Mux3~1_combout\))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "1100010001100110",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => dut_input(3),
	datab => \dut_instance|add_instance|Mux3~1_combout\,
	datac => \dut_instance|add_instance|Equal1~2_combout\,
	datad => dut_input(4),
	combout => \dut_instance|add_instance|Mux3~2_combout\);
...
-- Equation(s):
-- \datau[1]~7_combout\ = (\shift_reg~1_combout\ & ((dut_input(7) & (!dut_input(3))) # (!dut_input(7) & ((dut_input(3)) # (!\dut_instance|add_instance|Equal0~1_combout\)))))
...
-- Equation(s):
-- \datau[1]~4_combout\ = (dut_input(3)) # ((\dut_instance|add_instance|LessThan0~2_combout\ & !dut_input(7)))
...
-- Equation(s):
-- \datau[1]~5_combout\ = (dut_input(3)) # (dut_input(7))
...
-- Equation(s):
-- \datau[2]~11_combout\ = (\datau[1]~4_combout\ & (\datau[1]~5_combout\ $ (((dut_input(6)))))) # (!\datau[1]~4_combout\ & (dut_input(2) & ((dut_input(6)) # (!\datau[1]~5_combout\))))
...
PORT MAP (
	...
	datab => \datau[1]~5_combout\,
	datac => dut_input(2),
	datad => dut_input(6),
	combout => \datau[2]~11_combout\);

-- Location: LCCOMB_X37_Y21_N20
\datau[3]~13\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \datau[3]~13_combout\ = (dut_input(3) & (\shift_reg~1_combout\ & ((\dut_instance|add_instance|Equal1~2_combout\) # (!dut_input(7)))))
...
PORT MAP (
	dataa => dut_input(3),
	datab => \dut_instance|add_instance|Equal1~2_combout\,
	datac => dut_input(7),
	datad => \shift_reg~1_combout\,
	combout => \datau[3]~13_combout\);

-- Location: LCCOMB_X37_Y21_N16
\datau[3]~14\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \datau[3]~14_combout\ = (\datau[3]~13_combout\) # ((!\shift_reg~0_combout\ & (!\shift_reg~1_combout\ & datau(3))))
...
-- Equation(s):
-- \datau[1]~2_combout\ = (dut_input(3) & (\dut_instance|add_instance|Equal1~2_combout\ & (dut_input(7) & \shift_reg~1_combout\)))
...
-- Equation(s):
-- \datau[2]~10_combout\ = (dut_input(6) & ((\datau[1]~2_combout\) # ((datau(3) & !\shift_reg~1_combout\)))) # (!dut_input(6) & (datau(3) & (!\shift_reg~1_combout\)))
...
-- Equation(s):
-- \datau[2]~12_combout\ = (\datau[2]~10_combout\) # ((\datau[2]~11_combout\ & \datau[1]~7_combout\))
...
-- Equation(s):
-- \datau[1]~3_combout\ = (datau(2) & (((dut_input(5) & \datau[1]~2_combout\)) # (!\shift_reg~1_combout\))) # (!datau(2) & (dut_input(5) & ((\datau[1]~2_combout\))))
...
-- Equation(s):
-- \datau[1]~6_combout\ = (\datau[1]~4_combout\ & (dut_input(5) $ ((\datau[1]~5_combout\)))) # (!\datau[1]~4_combout\ & (dut_input(1) & ((dut_input(5)) # (!\datau[1]~5_combout\))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "0110101101100000",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => dut_input(5),
...
-- Equation(s):
-- \datau[1]~8_combout\ = (\datau[1]~3_combout\) # ((\datau[1]~7_combout\ & \datau[1]~6_combout\))
...
-- Equation(s):
-- \datau[0]~0_combout\ = (!\shift_reg~1_combout\ & ((\shift_reg~0_combout\ & ((datau(1)))) # (!\shift_reg~0_combout\ & (datau(0)))))
...
-- Equation(s):
-- \datau[0]~1_combout\ = (\datau[0]~0_combout\) # ((\dut_instance|add_instance|Mux3~2_combout\ & \shift_reg~1_combout\))
...
-- pragma translate_on
PORT MAP (
	dataa => \dut_instance|add_instance|Mux3~2_combout\,
	datac => \shift_reg~1_combout\,
